...
def connectsql():
    conn = pymysql.connect(host='db-1.chhkffyll2tw.ap-northeast-2.rds.amazonaws.com', user = 'admin', passwd = '12341234', db = 'userlist')
    return conn
...
def post():
    ...
    query = "SELECT id, name, title, view FROM board ORDER BY id DESC" # ORDER BY 컬럼명 DESC : 역순출력, ASC : 순차출력
